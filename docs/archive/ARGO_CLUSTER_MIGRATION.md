...
> 🗃️ **Archived.** This document records the migration performed in early 2026. The current architecture is described in [ARCHITECTURE_PLAN.md](../architecture/ARCHITECTURE_PLAN.md).
