...
#### ☁️ 1. Cloudflare API token in plaintext
...
#### ▪️ 2. Argo CD admin password in plaintext
...
#### ▪️ 5. Unrendered template variable in internal Gateway
...
#### ▪️ 6. LB IP pool overlaps with node addresses
...
#### ▪️ 8. No memory requests on workloads
...
#### ▪️ 10. No pod anti-affinity for CoreDNS
...
#### ▪️ 12. No Pod Security Standards
...
#### ▪️ 13. Admission control plugins deleted
...
#### ▪️ 18. `imagePullPolicy: Always` on gitops-tools init container
...
#### ▪️ 20. cert-manager single replica
...
#### ☁️ 21. Cloudflare-dns chart source inconsistency
